...
<section id="breadcrumbs" class="breadcrumbs">
  <div class="container">
	<ol>
	  ...
	  <li>Divisi Pendidikan dan Pelatihan</li>
	</ol>
	<h2><?= $sub; ?></h2>
  </div>
	...
	<div class="row gy-4">
	  ...
	  <div class="col-lg-4">
		<div class="galeri-info">
		  <h3>Divisi Pendidikan dan Pelatihan</h3>
		  <ul>
			<li><strong>Nama</strong>: Muhamad Farhan Rajab, Nazaruddin, M. Nur Fajar, Agil Almunawar</li>
